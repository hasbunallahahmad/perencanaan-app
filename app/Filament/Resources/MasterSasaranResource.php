...
use App\Filament\Resources\MasterSasaranResource\Pages;
use App\Filament\Resources\MasterSasaranResource\RelationManagers;
...
class MasterSasaranResource extends Resource
{
    protected static ?string $model = MasterSasaran::class;
    protected static ?string $navigationGroup = 'Master Data';
    protected static ?string $navigationLabel = 'Master Sasaran ';
            ...
            ->schema([
                Forms\Components\Section::make('Informasi Master Tujuan & Sasaran')
                    ...
                    ->schema([
                        ...
                        Forms\Components\Textarea::make('indikator_sasaran')
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('indikator_sasaran')
                    ->label('Indikator Sasaran')
                    ->limit(255)
                    ->wrap()
                    ->tooltip(function (Tables\Columns\TextColumn $column): ?string {
    ...
    {
        return [
            'index' => Pages\ListMasterSasarans::route('/'),
            'create' => Pages\CreateMasterSasaran::route('/create'),
            'edit' => Pages\EditMasterSasaran::route('/{record}/edit'),
        ];
    }
}
